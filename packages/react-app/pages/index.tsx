                ...
                <div className="relative flex space-x-3">
                  <div>
                    <span
                      className={
                        step.active
                          ? "bg-forest h-8 w-8 flex items-center justify-center ring-1 ring-onyx"
                          : "bg-gypsum h-8 w-8 flex items-center justify-center ring-1 ring-onyx"
                      }
                    >
                      {step.active && (
                        <LockOpenIcon
                  ...
                  <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                    <div>
                      <p className="text-xl text-onyx">{step.content}</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="bg-white py-8 px-4 border border-onyx sm:px-10">
                      <form
                        ...
                        onSubmit={(event) => {
                          ...
                          registerAttestation(socialIdentifier, address!);
                        }}
                      >
                        <div>
                          <label
                  ...
                  {step.id == 5 && address && (
                    <div className="bg-white py-8 px-4 border border-onyx sm:px-10">
                      <form
                        ...
                        onSubmit={(event) => {
                          event.preventDefault();
                          deregisterIdentifier(socialIdentifier);
                        }}
                      >
                        <div>
                          <label
